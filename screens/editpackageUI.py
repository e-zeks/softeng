...
"}")
        ...
        self.minimumsessions = QtWidgets.QLineEdit(self.widget_6)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(16)
        self.minimumsessions.setFont(font)
        self.minimumsessions.setStyleSheet("QLineEdit{\n"
"background-color:white;\n"
"color:#5e3b96;\n"
"}")
        self.minimumsessions.setObjectName("minimumsessions")
        self.verticalLayout_5.addWidget(self.minimumsessions)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Minimum number of Sessions:"))

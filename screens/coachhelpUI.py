...
# Form implementation generated from reading ui file 'C:\Users\JC\Desktop\DYNAMIC UI\coachhelp.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "For Clients"))
        ...
        self.label_2.setText(_translate("MainWindow", "For Schedule"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p>Select a date to view your schedule on selected date.</p><p>Once a date has been selected you are now able to<br/>select a client and specify if they have completed their<br/>session for today or not.</p><p>Make sure to save the data in order for the session to be<br/>saved.</p></body></html>"))

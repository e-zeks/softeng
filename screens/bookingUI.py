...
"}")
        ...
        self.address = QtWidgets.QLabel(self.widget_6)
        self.address.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(26)
        self.address.setFont(font)
        self.address.setStyleSheet("QLabel\n"
"{\n"
"color:white;\n"
"}")
        self.address.setObjectName("label_6")
...
"}")
        ...
        self.register_2 = QtWidgets.QPushButton(self.widget_8)
        self.register_2.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setFamily("Arial Black")

...
# Form implementation generated from reading ui file 'C:\Users\JC\Desktop\DYNAMIC UI\clienthelp.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "For Finalizing Selections"))
        ...
        self.label_4.setText(_translate("MainWindow", "For Package Selection"))
        self.label_9.setText(_translate("MainWindow", "<html><head/><body><p>Select a package that should work well with your goals.</p><p>The price and details will be shown for your information.</p><p>The number of sessions will be set at a minimum per<br/>package but can be added when changed in the next<br/>screen.</p><p>Once done, select them and you will be directed to the next page and continue on with your booking.</p></body></html>"))
        self.label_7.setText(_translate("MainWindow", "For Finalizing Schedule"))
        self.label_12.setText(_translate("MainWindow", "<html><head/><body><p>Select your preferred schedule and make sure you<br/>are satisfied with your choices.</p><p>Once done, select the confirm button to go to the next<br/>page and continue on with your booking.</p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "For Coach Selection"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p>Select a coach that should work well with your goals.</p><p>Their experiences and specialties will be displayed<br/>for your information.</p><p>Once done, select them and you will be directed to the next page and continue on with your booking.</p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "For Number of Sessions"))
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>Select the number of sessions that you would apply to<br/>your selected package.</p><p>The number of sessions will be set at the minimum of<br/>your selected package and if you choose to add <br/>sessions it will be added to the total.</p><p>Once done, select the proceed button and you will be directed to the next page to continue on with your booking.</p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "For Final Transaction"))
        self.label_13.setText(_translate("MainWindow", "<html><head/><body><p>Ensure that the details displayed are correct and aligns<br/>to your choices previously.</p><p>Once done, take a picture for your own copy.</p></body></html>"))

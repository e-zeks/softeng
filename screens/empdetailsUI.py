...
# Form implementation generated from reading ui file 'D:\zek\3rd yr comsci\summer\CS 304\soft eng\github\qt\empdetails.ui'
#
...
"}")
        ...
        self.back.setMinimumSize(QtCore.QSize(90, 45))
...
"}")
        ...
        self.username = QtWidgets.QLineEdit(self.widget_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.loa = QtWidgets.QComboBox(self.widget_7)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(24)
        self.loa.setFont(font)
        self.loa.setStyleSheet("QComboBox{\n"
"background-color:white;\n"
"color:#5e3b96;\n"
"}")
        self.loa.setObjectName("loa")
        self.loa.addItem("")
        self.loa.setItemText(0, "")
        self.loa.addItem("")
        self.loa.addItem("")
        self.loa.addItem("")
        self.verticalLayout_5.addWidget(self.loa)
...
"}")
        ...
        self.contactno = QtWidgets.QLineEdit(self.widget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.contactno)
...
"}")
        ...
        self.emailadd = QtWidgets.QLineEdit(self.widget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.emailadd)
...
"}")
        ...
        spacerItem11 = QtWidgets.QSpacerItem(39, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        ...
        self.save.setMinimumSize(QtCore.QSize(240, 50))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
...
"}")
        ...
        spacerItem15 = QtWidgets.QSpacerItem(150, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Level of Access:"))
        self.loa.setItemText(1, _translate("MainWindow", "Admin"))
        self.loa.setItemText(2, _translate("MainWindow", "Coach"))
        self.loa.setItemText(3, _translate("MainWindow", "Auditor"))
        ...
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt;\">Ensure that your details are final before saving changes.</span></p><p align=\"center\"><span style=\" font-size:20pt;\"><br/></span></p></body></html>"))
        self.label_11.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt;\">Notify the user after successfully updating their account.</span></p></body></html>"))
        self.save.setText(_translate("MainWindow", "Save Changes"))

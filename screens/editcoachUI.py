...
"}")
        ...
        self.fullname = QtWidgets.QLineEdit(self.widget_6)
        ...
        self.fullname.setStyleSheet("QLineEdit{\n"
"background-color:white;\n"
"color:#5e3b96;\n"
"}")
        self.fullname.setReadOnly(False)
        self.fullname.setObjectName("fullname")
        self.verticalLayout_5.addWidget(self.fullname)
...
"}")
        ...
        self.experience = QtWidgets.QTextEdit(self.widget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.experience.sizePolicy().hasHeightForWidth())
        self.experience.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(16)
        self.experience.setFont(font)
        self.experience.setStyleSheet("QTextEdit{\n"
"background-color:white;\n"
"color:#5e3b96;\n"
"}")
...
"}")
        ...
        self.specialties = QtWidgets.QTextEdit(self.widget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.specialties.sizePolicy().hasHeightForWidth())
        self.specialties.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(16)
        self.specialties.setFont(font)
        self.specialties.setStyleSheet("QTextEdit{\n"
"background-color:white;\n"
"color:#5e3b96;\n"
"}")
        self.specialties.setObjectName("specialties")
        self.verticalLayout_4.addWidget(self.specialties)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "Edit Coach"))
        self.label_2.setText(_translate("MainWindow", "Coach"))
        self.label_3.setText(_translate("MainWindow", "Coach Name:"))
        self.label_5.setText(_translate("MainWindow", "Experience:"))
        self.label_6.setText(_translate("MainWindow", "Specialties:"))

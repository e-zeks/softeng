...
"}")
        ...
        self.getdata = QtWidgets.QPushButton(self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.getdata.sizePolicy().hasHeightForWidth())
        self.getdata.setSizePolicy(sizePolicy)
        self.getdata.setMinimumSize(QtCore.QSize(75, 45))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.getdata)
...
"}")
        ...
        self.currentmonth.setItemText(0, "")
        self.currentmonth.addItem("")
        self.currentmonth.addItem("")
        self.currentmonth.addItem("")
        self.currentmonth.addItem("")

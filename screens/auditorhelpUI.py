...
# Form implementation generated from reading ui file 'C:\Users\JC\Desktop\DYNAMIC UI\auditorhelp.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "For Client Report"))
        self.label_9.setText(_translate("MainWindow", "<html><head/><body><p>Choose a report name for the file.</p><p>Select the current month of the report you are generating.</p><p>Once a month is selected, press the get data button to<br/>update the data with information only for the selected month.</p><p>Double check the summarized data below before saving the report to the system.</p><p><br/></p></body></html>"))
        self.label_12.setText(_translate("MainWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "For Coach Report"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p>Choose a report name for the file.</p><p>Select the current month of the report you are generating.</p><p>Once a month is selected, press the get data button to<br/>update the data with information only for the selected month.</p><p>Double check the summarized data below before saving the report to the system.</p><p><br/></p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "For Transactions Report"))
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>Choose a report name for the file.</p><p>Select the current month of the report you are generating.</p><p>Once a month is selected, press the get data button to<br/>update the data with information only for the selected month.</p><p>Double check the summarized data below before saving the report to the system.</p><p><br/></p></body></html>"))

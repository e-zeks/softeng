...
"}")
        ...
        self.label_4.setMaximumSize(QtCore.QSize(16777215, 43))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(20)
        font.setBold(True)
...
"}")
        ...
        self.retypepassword = QtWidgets.QLineEdit(self.widget_6)
        self.retypepassword.setMaximumSize(QtCore.QSize(16777215, 43))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(19)
        self.retypepassword.setFont(font)
        self.retypepassword.setStyleSheet("QLineEdit\n"
"{\n"
"background-color:white;\n"
"color: #5e3b96;\n"
"}")
        self.retypepassword.setObjectName("retypepassword")
        self.verticalLayout_3.addWidget(self.retypepassword)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">Reset Password<br/></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "Password"))
        self.label_4.setText(_translate("MainWindow", "Retype Password"))

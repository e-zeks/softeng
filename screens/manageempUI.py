...
class ManageEmpWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.employees.clicked.connect(self.load_data)  # Connect the button to load_data method
        ...
        for row in range(self.table.rowCount()):
            ...
            for column in range(self.table.columnCount()):
                ...
                if item and search_text in item.text().lower():
                    item_visible = True
                    break
            self.table.setRowHidden(row, not item_visible)
